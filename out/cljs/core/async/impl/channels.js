...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t23661 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t23661 = (function (val,box,meta23662){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t23661.cljs$lang$type = true;
cljs.core.async.impl.channels.t23661.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t23661";
cljs.core.async.impl.channels.t23661.cljs$lang$ctorPrWriter = (function (this__4045__auto__,writer__4046__auto__,opt__4047__auto__){return cljs.core._write.call(null,writer__4046__auto__,"cljs.core.async.impl.channels/t23661");
});
cljs.core.async.impl.channels.t23661.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t23661.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_23663){var self__ = this;
var _23663__$1 = this;return self__.meta23662;
});
cljs.core.async.impl.channels.t23661.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_23663,meta23662__$1){var self__ = this;
var _23663__$1 = this;return (new cljs.core.async.impl.channels.t23661(self__.val,self__.box,meta23662__$1));
});
cljs.core.async.impl.channels.__GT_t23661 = (function __GT_t23661(val__$1,box__$1,meta23662){return (new cljs.core.async.impl.channels.t23661(val__$1,box__$1,meta23662));
});
}
return (new cljs.core.async.impl.channels.t23661(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_23664 = self__.takes.pop();if((taker_23664 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_23664))
{var take_cb_23665 = cljs.core.async.impl.protocols.commit.call(null,taker_23664);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_23665,taker_23664,this$__$1){
return (function (){return take_cb_23665.call(null,null);
});})(take_cb_23665,taker_23664,this$__$1))
);
} else
{}
{
