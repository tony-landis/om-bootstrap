...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_23655 = 0;while(true){
var m_23656 = cljs.core.async.impl.dispatch.tasks.pop();if((m_23656 == null))
{} else
{m_23656.call(null);
if((count_23655 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__23657 = (count_23655 + 1);
count_23655 = G__23657;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3466__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3466__auto__)
